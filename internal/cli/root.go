...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "youtube-analytics-pp-cli",
		Short: `YouTube Analytics CLI with a local archive, period-over-period deltas, multi-channel rollups, and anomaly detection`,
		Long: `YouTube Analytics CLI with a local archive, period-over-period deltas, multi-channel rollups, and anomaly detection.
...
Health check: run 'youtube-analytics-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("youtube-analytics-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'youtube-analytics-pp-cli profile list')")
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("youtube-analytics-pp-cli %s\n", version)
		},
	}
}
