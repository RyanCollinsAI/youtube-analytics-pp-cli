...
but do not stop the import.`,
  ...
  youtube-analytics-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  youtube-analytics-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | youtube-analytics-pp-cli import <resource> --input -`,
